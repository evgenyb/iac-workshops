...
@description('If you choose true, create and configure a Azure Log Analytics at the same time.')
@allowed([
  true
  false
])
param createWithLogAnalytics bool = false

@description('If you use your own Log Analytics, specify Log Analytics resource id')
param logAnalyticsWorkspaceResourceId string

@description('An array of NameValuePair objects to configure DNS provider settings.')
